...
function formatImageData(rawImage) {
    ...
    tmpReturnData.img_url = '/bing-image/'+rawImage.year+'/'+rawImage.month+'/'+rawImage.day+'/1920x1080.jpg';
    tmpReturnData.img_url_thumbnail = '/bing-image/'+rawImage.year+'/'+rawImage.month+'/'+rawImage.day+'/400x240.jpg';
    tmpReturnData.img_url_base = '/bing-image/'+rawImage.year+'/'+rawImage.month+'/'+rawImage.day;
